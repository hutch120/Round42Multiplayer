...
import { FullScreen } from '../Providers/RequestFullscreen'
...
export default function MainMenu(props: {
  ...
  function goToSource(): void {
    const win = window.open('https://github.com/hutch120/r42ts', '_blank')
    if (win !== null) {
      win.focus()
    }
  }
    ...
    <div style={Styles.page}>
      ...
      <div style={Styles.defaultTextContainer}>
        ...
        <ul>
          ...
          <li>When you die you will lose your phaser charges.</li>
          <li>
            When you die you can hold the Pause key to stop your formation. While forming you cannot
            be hit.
          </li>
          <li>
            When there are enemies on the screen you can move left and right while your ship is
            forming.
          </li>
        </ul>
