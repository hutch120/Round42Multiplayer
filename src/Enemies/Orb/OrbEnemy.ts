...
export default class OrbEnemy extends BaseEnemy {
  ...
  constructor(
    ...
    Mutators.FrameSetColor(this.explosion.explosionCenterFrame, CGAColors.magenta)
    this.explosion.particleFrames.forEach((pf) => Mutators.FrameSetColor(pf, CGAColors.magenta))
  ...
  private updateCurrentFrameAndColor(frame: Frame): void {
    ...
    Mutators.FrameSetColor(frame, ...currentColor)
