...
import * as KeybindingsMapping from '../Settings/KeybindingsMapping'
import * as Constants from './KeyboardConstants'
 ...
 */
export default function keyboardStateReducer(
  state: KeyboardState = initState(),
  action: KeyboardTypes
): KeyboardState {
