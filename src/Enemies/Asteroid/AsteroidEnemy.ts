...
export class AsteroidEnemy extends BaseEnemy {
  ...
  constructor(
    ...
    Mutators.FrameSetColor(this.explosion.explosionCenterFrame, CGAColors.lightRed)
    this.explosion.particleFrames.forEach((pf) => Mutators.FrameSetColor(pf, CGAColors.lightRed))
  }
