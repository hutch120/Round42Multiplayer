...
import * as EnemyLevelRunner from './Runners/EnemyLevelRunner'
...
function start(): void {
  ...
  registerForegroundDrawing(drawStatusBar)
  ...
  registerUpdateState(genericRunner)
  ...
  registerUpdateState(levelProgressionRunner)
  ...
  registerUpdateState(playerSpawnRunner)
